...
export const ActionButton: React.FC<{
 ...
 return (
  <Button variant={variant} onClick={onClick} className={`h-[36px] my-[12px] mx-[18px] ${borderColor}  rounded-[8px] text-14 font-semibold ${className}`}>
   {icon}
