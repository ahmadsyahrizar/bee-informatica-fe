...
import iconUploadSuccess from "@/assets/icons/icon-upload-success.svg";
   ...
   <div className="w-[420px] rounded-2xl bg-white p-[24px] shadow-xl">
    <div className="relative">
     <div className="flex flex-col items-center justify-center gap-2">
      <Image src={iconUploadSuccess} alt="reject upload" width={70} height={70} />
      <h2 className="text-lg font-semibold">File Successfully Uploaded</h2>
     </div>
    ...
    <div className="my-[20px] rounded-xl border border-gray-200 p-[16px]">
     <div className="flex items-center gap-3">
      <Image src={Icon} alt="uploaded" width={40} height={40} />
    ...
    <div className="flex flex-col gap-3">
     <Button className="w-full bg-brand-500 !text-white text-16 font-semibold" onClick={onGenerate}>
      {stage === "video" ? "Generate Transcription & Video Log" : "Generate Transcription & Call Log"}
     </Button>
     <Button variant="outline" className="w-full border-gray-300" onClick={onDiscard}>
      Discard
     </Button>
    </div>
   </div>
